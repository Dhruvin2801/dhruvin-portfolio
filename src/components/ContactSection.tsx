...
export const ContactSection = () => {
  const contactInfo = [
    {
      icon: Mail,
      label: "Email",
      value: "dhruvindungrani@gmail.com",
      href: "mailto:dhruvindungrani@gmail.com",
    },
    {
      icon: Phone,
      label: "Phone",
  ...
  const socialLinks = [
    ...
    },
    {
      icon: Github,
      label: "GitHub",
      href: "https://github.com/Dhruvin2801",
    },
    {
      icon: Mail,
      label: "Email",
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16 animate-fade-in">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Ready to discuss opportunities, collaborations, or just want to
              chat about data analytics and product management? I'd love to
              hear from you.
            </p>
          </div>
            ...
            <div className="animate-slide-in space-y-8">
              ...
              <Card className="bg-gradient-to-r from-primary/20 to-primary/10 border-primary/30">
                <CardContent className="p-8 text-center">
                  ...
                  <a
                    href="https://calendly.com/alextonks57/30min"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <Button variant="hero">Schedule a Call</Button>
                  </a>
                </CardContent>
              </Card>
            </div>
